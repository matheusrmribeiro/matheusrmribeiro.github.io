...
_1607: x0 => x0.createRange(),
_1608: (x0,x1) => x0.selectNode(x1),
_1609: x0 => x0.getSelection(),
_1610: x0 => x0.removeAllRanges(),
_1611: (x0,x1) => x0.addRange(x1),
_1612: (x0,x1) => x0.createElement(x1),
_1613: (x0,x1) => x0.add(x1),
_1614: (x0,x1) => x0.append(x1),
_1615: (x0,x1,x2) => x0.insertRule(x1,x2),
_1616: f => finalizeWrapper(f,x0 => dartInstance.exports._1616(f,x0)),
_1617: (x0,x1) => x0.matchMedia(x1),
_1628: x0 => new Array(x0),
_1631: (o, c) => o instanceof c,
...
_1692: () => globalThis.performance,
_1693: () => globalThis.JSON,
_1694: x0 => x0.measure,
_1695: x0 => x0.mark,
_1696: (x0,x1,x2,x3) => x0.measure(x1,x2,x3),
_1697: (x0,x1,x2) => x0.mark(x1,x2),
_1698: (x0,x1) => x0.parse(x1),
...
_1824: x0 => x0.pop(),
_1825: x0 => globalThis.Object.keys(x0),
_1827: (x0,x1) => x0[x1],
